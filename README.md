[![Run App SebastianWysocki](https://github.com/swysocki9089/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/swysocki9089/GithubActions/actions/workflows/run-app.yaml)
